...
local SKIN = {}
SKIN.PanelFrameColor = Color( 50, 50, 50 )
SKIN.PanelContainerColor = Color( 210, 210, 210 )
SKIN.PanelContainerInnerColor = Color( 100, 100, 100 )
...
SKIN.Colours = table.Copy( derma.GetDefaultSkin( ).Colours )
SKIN.Colours.Label = {}
SKIN.Colours.Label.Default = color_black
SKIN.Colours.Label.Bright = SKIN.ItemDescPanelBorder
...
derma.DefineSkin( "LoadoutClean", "Default Derma with Loadout Clean extensions", SKIN )
